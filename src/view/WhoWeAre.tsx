...
function WhoWeAre() {
    ...
    return (
        ...
        <div ref={globalStateContext.AboutUsRef} className="text-center space-y-7 h-full p-5 md:px-[8%] xl:px-[120px] md:py-[120px]">
            ...
            <div className="text-gray-80 text-lg md:text-2xl md:font-medium tracking-[0.72px] md:tracking-[1px]">
                <p>Our team is a vibrant mix of smart, passionate individuals, united by a commitment to excellence and collaboration.</p>
            </div>
            <div className="flex flex-col-reverse md:flex-row md:pt-8">
                <div className="relative flex justify-center items-center md:w-1/2">
                    <img className="relative h-[252px] min-w-[320px] md:h-[320px] md:min-w-[300px] md:min-h-[320px] xl:h-[400px] rounded-3xl" src={office_comp}/>
                </div>
